...
const UserDetailsForm = () => {
    ...
    return (
        <div className="min-h-screen bg-amber-50 w-full flex flex-col lg:flex-row mx-auto max-w-screen-2xl">
            <div className="flex items-center justify-center w-full lg:w-1/2 p-4 sm:p-6 lg:p-12 min-h-screen">                <Card className="w-full max-w-[600px]">
                <CardHeader>
